...
<img alt="img-products"src={img1}  style={{width:"100%"}} />
...
<img alt="img-products"src={img2} />

</div>  

<div className="content-man mt-5">
<a href="#" className="btn btn-sm   p-3 btn-outline-white position-absolute collection">View Collections</a>
<img alt="img-products"src={img3} />
...
<Link to="/products-details"><img alt="img-products"src={img4} className="img-fluid" style={{width:"100%",height: "350px" }} />
</Link>
...
<div className="col-md-3">
<Link to="/products-details"><img alt="img-products"src={img5} className="img-fluid" style={{width:"100%",height: "350px" }} />
</Link>
<h4> Womens kurti</h4>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
...
<div className="col-md-3">
<img alt="img-products"src={img6} className="img-fluid" style={{width:"100%",height: "350px" }} />
<h4> Womens kurti</h4>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
...
<div className="col-md-3">
<img alt="img-products"src={img7} className="img-fluid" style={{width:"100%",height: "350px" }} />
<h4> Womens kurti</h4>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
...
<div className="col-md-3">
<img alt="img-products"src={img8} className="img-fluid" style={{width:"100%",height: "350px" }} />
<h4> Womens kurti</h4>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
...
<div className="col-md-3">
<img alt="img-products"src={img9} className="img-fluid" style={{width:"100%",height: "350px" }} />
<h4> Womens kurti</h4>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
...
<div className="col-md-3">
<img alt="img-products"src={img10} className="img-fluid" style={{width:"100%",height: "350px" }} />
<h4> Womens kurti</h4>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
...
<div className="col-md-3">
<img alt="img-products"src={img11} className="img-fluid" style={{width:"100%",height: "350px" }} />
<h4> Womens kurti</h4>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
...
<img alt="img-products"src={img10} />
...
<div className="col-md-3">
<img alt="img-products"src={img12} className="img-fluid" style={{width: "100%",height:"350px" }} />
<h4> Womens kurti</h4>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
...
<div className="col-md-3">
<img alt="img-products"src={img13} className="img-fluid" style={{width: "100%",height:"350px" }} />
<h4> Womens kurti</h4>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
<span className="bi bi-star-fill text-danger"></span>
...
<img alt="img-products"src="#" className="d-block w-100" alt="..." />
...
<p className="text-center"><img alt="img-products"src={img17} className="rounded-circle" style={{width:"85px",height:"85px" }}/></p>
</blockquote>
...
<blockquote>
<p className="text-center"><q>Nunc vulputate odio vitae sapien euismod rhoncus. Vestibulum ante orci, elemet molestie sed, efficitur a augue. Quisque placerat laoreet lorem” </q></p>
<p className="text-center"><img alt="img-products"src={img16} className="img-fluid  rounded-circle" style={{width:"85px",height:"85px"}} /></p>
</blockquote>
...
<blockquote>
<p className="text-center"><q>Nunc vulputate odio vitae sapien euismod rhoncus. Vestibulum ante orci, elemet molestie sed, efficitur a augue. Quisque placerat laoreet lorem” </q> </p>
<p className="text-center"><img alt="img-products"src={img15} className="img-fluid  rounded-circle" style={{width: "85px", height:"85px" }} /></p>
</blockquote>
...
<div className="card">
<img alt="img-products"src={img1} className="img-fluid" style={{width: "100%", height: "250px;" }} />
...
<div className="col-md-4">
<div className="card">
<img alt="img-products"src={img2} className="img-fluid" style={{width: "100%", height:"250px" }} />
<div className="card-body p-3">
<h4>Some heading here</h4>
<p>Vivamus ultrices ut erat ut ullamcorper. Sed sem est, pellentesque auctor malesuada in, sollicitupulvinar metus. Aliquam scelerisque aliquet faucibus</p>
<p><button type="button" className="btn btn-sm btn-outline-dark">Read More</button></p>
...
<div className="col-md-4">
<div className="card">
<img alt="img-products"src={img5} className="img-fluid" style={{width: "100%", height: "250px" }} />
<div className="card-body p-3">
<h4>Some heading here</h4>
<p>Vivamus ultrices ut erat ut ullamcorper. Sed sem est, pellentesque auctor malesuada in, sollicitupulvinar metus. Aliquam scelerisque aliquet faucibus</p>
<p><button type="button" className="btn btn-sm btn-outline-dark">Read More</button></p>
...
<div>
<img alt="img-products"src={img5} style={{width: "100%", height: "150px" }} />
</div>
<div>
<img alt="img-products"src={img6} style={{width: "100%", height: "150px" }} />
</div>
<div>
<img alt="img-products"src={img7} style={{width: "100%", height: "150px" }} />
</div>
<div>
<img alt="img-products"src={img8} style={{width: "100%", height: "150px" }} />
</div>
<div>
<img alt="img-products"src={img14} style={{width: "100%", height: "150px" }} />
</div>
<div>
<img alt="img-products"src={img15} style={{width: "100%", height: "150px" }} />
</div>
<div>
<img alt="img-products"src={img16} style={{width: "100%", height: "150px" }} />
</div>
</section>
</div>
</div>
