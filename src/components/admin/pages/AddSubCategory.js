...
export default function AddSubCategory() {
  return (
    ...
    <h3 className='ms-5 fs-6 p-2'>Dashboard/Add SubCategory</h3>
    <hr className='border border-1 bg-white w-25 mx-auto' />
    </div>
    <h3 className='ms-5 fs-4 p-2'>Add SubCategory</h3>
...
<input type="text" class="form-control" id="exampleFormControlInput1" placeholder="SubCategory Name *" />
</div>
...
<div class="mb-3">
<input type="submit" class="btn btn-dark text-white" value="AddSubCategory" />
